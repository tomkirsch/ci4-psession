...
class ComposerAutoloaderInit96945fb3975638d46022e46c4c3abe66
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit96945fb3975638d46022e46c4c3abe66::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire96945fb3975638d46022e46c4c3abe66($fileIdentifier, $file);
        }
...
function composerRequire96945fb3975638d46022e46c4c3abe66($fileIdentifier, $file)
{
